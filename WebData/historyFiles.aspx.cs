    ...
    public partial class historyFiles : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                html.Append("<tr>");
                html.Append("<td>");
                html.Append(row["name"].ToString());
                html.Append("</td>");

                html.Append("<td>");
                html.Append("Vigencia Del: " + Convert.ToDateTime(row["dateIni"]).ToString("dd/MM/yyyy") + " Al: " + Convert.ToDateTime(row["dateFin"]).ToString("dd/MM/yyyy"));
                html.Append("</td>");

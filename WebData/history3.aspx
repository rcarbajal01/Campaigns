<%@ Page Title="" Language="C#" MasterPageFile="~/login.Master" AutoEventWireup="true" CodeFile="history3.aspx.cs" Inherits="WebData.History3" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="center col-sm-5 col-sm-offset-3 col-md-6 col-md-offset-2 main">
                <h3 class="sub-header">Descargar Primera Factura</h3>
                <div class="well">

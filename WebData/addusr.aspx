<%@ Page Title="" Language="C#" MasterPageFile="~/login.Master" AutoEventWireup="true" CodeFile="addusr.aspx.cs" Inherits="WebData.addusr" %>
                        ...
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                ...
                                <select name="usrtype" id="usrtype" class="form-control">
                                    <option data-icon="glyphicon glyphicon-heart" value="Venta">Usuario Venta</option>
                                    <option data-icon="glyphicon glyphicon-heart" value="Activacion">Usuario Activación</option>
                                    <option data-icon="glyphicon glyphicon-heart" value="BackOffice">Usuario Primera Factura</option>
                                    <option data-icon="glyphicon glyphicon-heart" value="Cobranza">Usuario Cobranza</option>

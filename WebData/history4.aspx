<%@ Page Title="" Language="C#" MasterPageFile="~/login.Master" AutoEventWireup="True" Inherits="WebData.history4" CodeFile="history4.aspx.cs" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="center col-sm-5 col-sm-offset-3 col-md-6 col-md-offset-2 main">
                <h3 class="sub-header">Descargar Cobranza</h3>
                <div class="well">

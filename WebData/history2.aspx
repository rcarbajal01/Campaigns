<%@ Page Title="" Language="C#" MasterPageFile="~/login.Master" AutoEventWireup="true" CodeFile="history2.aspx.cs" Inherits="WebData.History2" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="center col-sm-5 col-sm-offset-3 col-md-6 col-md-offset-2 main">
                <h3 class="sub-header">Descargar Activaciones</h3>
                <div class="well">

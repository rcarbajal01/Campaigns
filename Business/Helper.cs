...
namespace Business
{
    public class Helper : IDisposable
    {
        ...
        /// <returns></returns>
        public string loadDnsFile(string file, string user, DateTime dateIni, DateTime dateFin)
        {
            ...
            if (System.IO.File.Exists(file))
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    parametersRecord.Add(new Parametro("userVal", user));                    
                    parametersRecord.Add(new Parametro("status", status));
                    parametersRecord.Add(new Parametro("idFile", idFile));
                    parametersRecord.Add(new Parametro("dateIni", dateIni));
                    parametersRecord.Add(new Parametro("dateFin", dateFin));
        ...
        public string checkLogin(string user, string password)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT isLogged FROM Users " +
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (isLogged != 1)
                    {
                        ...
                        SqlCommand cmd2 = new SqlCommand("update Users set islogged=1  where username='" + user + "'", conn);
        ...
        public void logout(string usr)
        {
            ...
            {
                SqlCommand cmd2 = new SqlCommand("update Users set islogged=0  where username='" + usr + "'", conn);
                SqlDataAdapter sda2 = new SqlDataAdapter();
                cmd2.ExecuteNonQuery();
        ...
        public string usrType(string user)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT profile FROM Users " +
        ...
        public DataTable getUsers()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT idUser, username, name  FROM Users ORDER BY username", conn);
                SqlDataAdapter sda = new SqlDataAdapter();
                sda.SelectCommand = cmd;
        ...
        public DataTable getInfo()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT TOP 1 idRecord, dn, FVC, name1, name2, lastName, middleName, Phone1, Phone2, date, userVal  FROM Record  where status = 0 and usedb= 1 order by idRecord", conn);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    SqlCommand cmd2 = new SqlCommand("update Record set status=2  where idRecord=" + id, conn);
                    SqlDataAdapter sda2 = new SqlDataAdapter();
                    cmd2.ExecuteNonQuery();
        ...
        public DataTable getHistory()
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("select distinct[file].idFile,  [file].name, [Record].dateIni, [Record].dateFin from [file] join Record on [File].idFile = Record.idFile", conn);
        ...
        public void deleteUser(string id)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE FROM Users WHERE idUser = '" + id + "'", conn);
                cmd.ExecuteNonQuery();
            }
            conn.Close();
        }
        ...
        public void addUser(string name, string usr, string pwd, string utype)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("INSERT INTO Users VALUES('" + name + "','" + usr + "','" + pwd + "','active','" + utype + "',0)", conn);
                cmd.ExecuteNonQuery();
            }
            conn.Close();
        ...
        public void updateReg(int id, string str, string modifiedby)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("update Record set status=1, StatusDesc='" + str + "', modifiedby='" + modifiedby + "' where idRecord=" + id, conn);
                cmd.ExecuteNonQuery();
            }
            conn.Close();
        ...
        public DataTable GetRecordsVenta(string p1, string p2)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT [dn]" +
                  ...
                  ",[HoraClienteDeseaLlamada] FROM Ventas " +
                    "WHERE CAST(Fecha_Venta AS DATE) >= '" + p1 + "' and CAST(Fecha_Venta AS DATE) <= '" + p2 + "'", conn);
